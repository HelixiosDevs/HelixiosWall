...
//    @GET("services/rest/?method=flickr.groups.pools.getPhotos&api_key=e90d3ec2187a5e2ca38e9cde3914a600&group_id=14741456%40N25&extras=url_o&format=json&nojsoncallback=1")
//    Call<SearchPhotos> getHomePhotos();
    ...
    Call<SearchPhotos> getCategoryPhotos(@Query("tags") String tags);
}
